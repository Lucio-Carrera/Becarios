...
Coordinación de Profesionistas en Entrenamiento', 0, 'J', false);
        ...
        $pdf->SetFont('narrow','',9);
        $pdf->SetXY(34, 88);
        $pdf->MultiCell(80,4,'SOLICITUD REPOSICIÓN DE PASE DE ACCESO PROFESIONISTA EN ENTRENAMIENTO C. '.utf8_decode($row['Nombre_Est']).' '.utf8_decode($row['ApPaterno_Est']).' '.utf8_decode($row['ApMaterno_Est']), 0, 'L', false);
        ...
        $pdf->SetXY(15, 165);
        $pdf->MultiCell(40,12,'', 1, 'J', false);
        $pdf->SetXY(15, 162);
        $pdf->MultiCell(40,12,'Accesos:', 0, 'J', false);
        $pdf->SetXY(55, 165);
        $pdf->MultiCell(146,12,'', 1, 'J', false);
        $pdf->SetXY(55, 165);
        ...
        $pdf->SetXY(15, 234);
        $pdf->MultiCell(60,4,''.$row2['cargo'], 0, 'J', false);
        $pdf->AddFont('narrow','','narrow.php'); //Arial, negrita, 12 puntos
        $pdf->SetFont('narrow','',8); //Arial, negrita, 12 puntos
        $pdf->SetXY(15, 240);
...
Coordinación de Profesionistas en Entrenamiento', 0, 'J', false);
        ...
        $pdf->SetXY(15, 234);
        $pdf->MultiCell(60,4,''.$cargo, 0, 'J', false);
        $pdf->AddFont('narrow','','narrow.php'); //Arial, negrita, 12 puntos
        $pdf->SetFont('narrow','',8); //Arial, negrita, 12 puntos
        $pdf->SetXY(15, 240);
        $pdf->MultiCell(80,4,'Elaboró: CMRM / MMR', 0, 'J', false);
