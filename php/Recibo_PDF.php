<?php
        ...
        if (isset($_GET['idalumno']) && isset($_GET['anoreg']) && isset($_GET['toficio']))
    {
        ...
        $fecha9=$meses[$date2[1]]." de ".$date2[0];
...
Coordinaci&oacuten de Profesionistas en Entrenamiento</b></td>
        ...
        <tr><td colspan="3">&nbsp;</td></tr>
        <tr>
            <td  colspan ="3" align="justify"><b>RECIB&Iacute</b> de Petr&oacuteleos Mexicanos la cantidad de <b><?php echo $row2['neto'].' '.$row2['cantidad'] ?></b> por concepto de ayuda econ&oacutemica como apoyo para desarrollar las actividades necesarias durante el per&iacuteodo del <b><?php echo $fecha3.' al '.$fecha4 ?></b>, a favor de <b>C.</b> <b><?php echo utf8_decode($row['Nombre_Est']).' '.utf8_decode($row['ApPaterno_Est']).' '.utf8_decode($row['ApMaterno_Est'])?></b>, con clave del Registro Federal de Contribuyentes <b><?php $row['RFC'] ?></b>, de conformidad con lo establecido en la cl&aacuteusula quinta del Convenio de Entrenamiento, de fecha <b><?php echo $fecha5?></b></td>
        </tr>
        <?php 
        /*<tr>
            <td  colspan ="3" align="justify">La erogaci&oacuten que se efect&uacutee por este concepto afectar&aacute el siguiente trinomio presupuestal: <b> <?php  'Centro Gestor: '. $row['CcGen'].', Centro de Costo: '.$row['ccosto'].', Posici&oacuten Financiera: '.$row['pfinanciera'].', Cuenta Mayor y Area Funcionanl: '.$row['cmayor'].', Programa Presupuestario: '.$row['ppresupuestario'].', Fondo: '.$row['fondo'].', Division: ' .$row['division'].', EPS: ' .$row['eps'] ?></td></b> -->


            <!-- QUITAR AREA FUNCIONAL DE AQUI-->
        </tr> */?>
    </table>
...
<table width="800" border =0>
        ...
        <tr><td align = center colspan="4"><b>AUTORIZA</b></td></tr> 
        <tr><td colspan="4">&nbsp;</td></tr>
        <tr><td colspan="4">&nbsp;</td></tr> 
        <tr><td colspan="4">&nbsp;</td></tr> 
        <tr><td colspan="4">&nbsp;</td></tr> 
        <tr><td align = center colspan="4"><b>ING. JOSE RAFAEL GOMEZ GOMEZ</b></td></tr> 
         <tr><td align = center colspan="4"><b>S.P.A. GERENCIA</b></td></tr> 
        <tr><td colspan="4">&nbsp;</td></tr>
        <tr><td colspan="4">&nbsp;</td></tr>
...
<td>
   <hr style="height:0.5px; border:none; color:#000; background-color:#000; ">
</td>
</tr>
</table>
...
<td align="left"  width="430"><b><?php echo $row2['nombredest'] ?>         
...
<td align="left"  width="430"> <font size=2>RECIBO DE PAGO PROFESIONISTA EN ENTRENAMIENTO</font> </td>
...
<table width="800" border=0>
    <tr><td><br><br><font size=3> Para tales efectos, se adjuntan el recibo de pago y la lista de asistencia. <br><br>Sin otro particular, reciba un cordial saludo.
<br><br>
<b>A t e n t a m e n t e , 
<br><br><br><br><br><br> <br><br></font>
<font size=4>
<?php echo ucwords(str_replace('\'', '\' ', strtolower(utf8_decode($row2['firmaofi'])))) ?>
<br>
<?php echo ucwords(str_replace('\'', '\' ', strtolower(utf8_decode($row2['cargo'])))) ?></font>
...
Coordinaci&oacuten de Profesionistas en Entrenamiento</b></td>
        ...
        <tr><td colspan="3">&nbsp;</td></tr>
        <tr>
            <td  colspan ="3" align="justify"><b>RECIB&Iacute</b> de Petr&oacuteleos Mexicanos la cantidad de <b><?php echo $neto.' '.$cantidad ?></b> por concepto de ayuda econ&oacutemica como apoyo para desarrollar las actividades necesarias durante el per&iacuteodo del <b><?php echo $fecha3.' al '.$fecha4 ?></b>, a favor de <b>C.</b> <b><?php echo utf8_decode($row['Nombre_Est']).' '.utf8_decode($row['ApPaterno_Est']).' '.utf8_decode($row['ApMaterno_Est'])?></b>, con clave del Registro Federal de Contribuyentes <b><?php $row['RFC'] ?></b>, de conformidad con lo establecido en la cl&aacuteusula quinta del Convenio de Entrenamiento, de fecha <b><?php echo $fecha5?></b></td>
        </tr>
       <?php /*<tr>
...
<tr>
        <td width="500"> <hr style = "height: .5px; border:none; color:#000; background-color:#000; margin-right:20px"> </td><td> <font face="Arial Narrow", Arial, sans-serif; size="2"> </font><hr style = "height: .5px; border:none; color:#000; background-color:#000; "></td></tr>
...
<td style="margin-right: 20px"  align="left"  width="410"><b><?php echo ($nombredest) ?>   
...
<tr>
        <td width="500"><hr style = "height: .5px; border:none; color:#000; background-color:#000; margin-right:20px"> </td><td> <hr style = "height: .5px; border:none; color:#000; background-color:#000;"> <font face="Arial Narrow", Arial, sans-serif; size="2">  </font></td></tr>
<tr>
...
<td align="left"  width="430">RECIBO DE PAGO PROFESIONISTA EN ENTRENAMIENTO </td>
...
<div>Agradeceremos a usted, se sirva gestionar el pago por concepto de Ayuda Econ&oacutemica otorgada al Profesionista en Entrenamiento, contemplada en las Pol&iacuteticas y Procedimientos de Administraci&oacuten de Recursos Humanos y Relaciones Laborales en el numeral III.3. Reclutamiento y Selecci&oacuten, en el apartado III.3.1.4 Personas Candidatas en Formaci&oacuten inciso 383) Para la atenci&oacuten del Programa de Profesionistas en Entrenamiento, 386) El convenio de entrenamiento, comprender&acute una ayuda equivalente, correspondiente al mes de <b><u><?php echo $fecha2 ?></u></b><br><br> </div>
        </td>
    </tr>
</table>
<table width="800" border=1px solid black>
